...
async function loadAllInvoice() {
    var url = 'http://localhost:8080/api/employee/allInvoice';
...
async function filterInvoice() {
    var url = 'http://localhost:8080/api/employee/allInvoiceFilter';
...
async function huydon() {
    ...
    var url = 'http://localhost:8080/api/employee/huydonAdmin?id='+id;
    const res = await fetch(url, {
        method: 'POST',
        headers: new Headers({
            'Authorization': 'Bearer ' + token
...
async function updateDon() {
    ...
    var url = 'http://localhost:8080/api/employee/updateTrangThai?id='+idinvoice+'&tt='+idtrangthai;
    const res = await fetch(url, {
        method: 'POST',
        headers: new Headers({
            'Authorization': 'Bearer ' + token
