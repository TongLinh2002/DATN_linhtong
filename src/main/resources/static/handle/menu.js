...
<div style="padding: 30px;padding-bottom: 50px;" class="section group">
    <div class="col_1_of_4 span_1_of_4">
        <div class="logo-footer">
            ...
            <p style="color: rgb(208, 208, 208);margin-top: 10px;">296 Cầu Diễn </p>
            <p style="color: rgb(208, 208, 208);padding: 0 !important;">Phường Minh Khai, Quận Bắc Từ Liêm, TP Hà Nội</p>
            <div style="display: flex;color: rgb(208, 208, 208);font-family: verdana, arial, helvetica, helve, sans-serif;margin-top: 12px;
            background: #9b3651;padding: 6px 10px;border-radius: 50px;width: 145px;"><ion-icon style="font-size: 25px;margin-bottom: -2px;" name="call"></ion-icon><p style="font-size: 14px;padding: 0;margin-top: 1px;margin-left: 4px;"> 0366345267</p></div>
        </div>
    </div>
    <div class="col_1_of_4 span_1_of_4">
